...
class MIR_DataLoader():
    ...
    def _create_data(self):
        spectrogram_paths = [
            ...
            "G:/Thesis/MIR_datasets/test_dataset/_c_spectrogram_base", #"MIR_datasets/test_dataset/spectrogram_base",
            "G:/Thesis/MIR_datasets/test_dataset/_c_spectrogram_no_post",#"MIR_datasets/test_dataset/spectrogram_no_post",
            "G:/Thesis/MIR_datasets/test_dataset/_c_spectrogram_with_post"#"MIR_datasets/test_dataset/spectrogram_with_post",
        ]
        ...
        if self.train == "test":
            y_train = pd.read_csv("MIR_datasets/MIR_test_labels_combined.csv").to_numpy() #MIR_test_labels_combined  - for test set
